...
const arrayImgBrClubs: Array<clubsImg> = [
  ...
  },
  {
    ...
    nome: 'Fortaleza',
    cidade: 'Fortaleza - CE',
    url: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/FortalezaEsporteClube.svg/180px-FortalezaEsporteClube.svg.png",
    estadio: 'Castelão'
  },
  {
    clube: 'Fluminense RJ',
      ...
      this.connectionService.executeGet(query)
        .subscribe((result: MatchesModel) => {
          for (let i = 0; i < result.matches.length; i++) {
            ...
            result.matches[i] = Object.assign(result.matches[i], {
              team1Img: teamsImg1[0].url,
